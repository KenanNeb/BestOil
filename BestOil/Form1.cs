...
namespace BestOil
{
    public partial class Form1 : Form
    {
        ...
        {
            if (checkBox1.Checked == true) {textBox3.ReadOnly = false; textBox3.Text = ""; }
            else { textBox3.ReadOnly = true; textBox3.Text = "0"; }

            if (checkBox2.Checked == true) {textBox6.ReadOnly = false; textBox6.Text = ""; }
            else { textBox6.ReadOnly = true; textBox6.Text = "0"; }

            if (checkBox3.Checked == true) {textBox8.ReadOnly = false; textBox8.Text = ""; }
            else { textBox8.ReadOnly = true; textBox8.Text = "0"; }

            if (checkBox4.Checked == true) {textBox10.ReadOnly = false; textBox10.Text = ""; }
